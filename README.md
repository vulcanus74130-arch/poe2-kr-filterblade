# POE2 KR FilterBlade Localizer

FilterBlade의 Path of Exile 2 화면과 아이템명을 한국어로 표시하는 Tampermonkey 유저스크립트입니다.

## 설치

1. Chrome에 [Tampermonkey](https://www.tampermonkey.net/)를 설치합니다.
2. [유저스크립트 설치](https://poe2-0-5-0-patch-notes.netlify.app/poe2-kr-filterblade.user.js) 링크를 엽니다.
3. Tampermonkey 설치 화면에서 `설치`를 누릅니다.
4. [FilterBlade](https://www.filterblade.xyz/?game=Poe2)를 새로고침합니다.

## 업데이트

Tampermonkey가 배포 서버의 최신 스크립트를 주기적으로 확인합니다.
